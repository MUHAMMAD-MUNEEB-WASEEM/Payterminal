  ...
  try {
    ...
    if (paymentData.token) {
      ...
      const paymentRequest = {
        ...
        firstname: paymentData.firstName || paymentData.cardHolder.split(' ')[0] || paymentData.cardHolder,
        lastname: paymentData.lastName || paymentData.cardHolder.split(' ').slice(1).join(' ') || '',
